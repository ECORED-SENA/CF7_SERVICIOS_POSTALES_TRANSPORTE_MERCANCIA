...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p Al momento de enviar un contenedor, la seguridad de la mercancía es una o la más importante de las prioridades, por lo que se requieren mecanismos de verificación a través de la identificación y los sellos (o precinto) de seguridad, obteniendo así información del contenido de los mismos. Mientras el sello asegura que el contenedor ha sido verificado antes de partir, y como solo se puede abrir una sola vez, ofrece mayor seguridad de la mercancía que transporta hasta su punto de llegada, ejerciendo un mayor control sobre la pérdida de las mercancías o el transporte de mercancía ilegal. 
